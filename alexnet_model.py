...
class AlexNet(object):
	...
	def __init__(self, images, keep_prob, num_classes, skip_layer):
		"""Create the graph of the AlexNet model.
		Args:
			images: Placeholder for the input batch of images.
...
def dropout(x, keep_prob):
	...
	return tf.nn.dropout(x, keep_prob)	# this is deprecated in the latest tf version ...
...
def loss_func(labels, logits_before_softmax):
	...
	# compute batch loss
	batch_loss = tf.math.reduce_mean(input_tensor=total_loss)
	# compute total loss
